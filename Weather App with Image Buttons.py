...
def aqi_data(event=None):
    ...
    try:
        ...
        error_label = Label(aqi_win, text="Error Connecting to API......", font='arial 20 bold')
...
aqi_image = ImageTk.PhotoImage(Image.open("D:/Python Codes/Tkinter Projects/Tkinter Weather App/qualitylogo.png"))

# label with image
aqi_label = Label(root, image=aqi_image)
aqi_label.grid(row=1,column=0, columnspan=1, padx=10, pady=10)

# bind click event to image
aqi_label.bind('<Button-1>', aqi_data)

# button with image binded to the same function 
aqi_button = Button(root, image=aqi_image, command=aqi_data)
aqi_button.grid(row=1,column=0,columnspan=1,padx=10,pady=10)
...
##D:/Python Codes/Tkinter Projects/Tkinter Weather App/weatherlogo.png

weather_image = ImageTk.PhotoImage(Image.open("D:/Python Codes/Tkinter Projects/Tkinter Weather App/weatherlogo.png"))

# label with image
weather_label = Label(root, image=weather_image)
weather_label.grid(row=1,column=1, columnspan=1, padx=10, pady=10)

# bind click event to image
weather_label.bind('<Button-2>', weather_data)

# button with image binded to the same function 
weather_button = Button(root, image=weather_image, command=weather_data)
weather_button.grid(row=1,column=1,columnspan=1,padx=10,pady=10)
